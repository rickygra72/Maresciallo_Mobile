...
TEXTS = {
    "🇮🇹 🇮🇹 Italiano": {
        ...
        "confirm_config": "💾 Salva e Torna alla Dashboard", "tab_dati": "📊 Inserimento Punteggi (Modulo Sicuro)",
        "tab_classifica": "🏆 Classifica Definitiva", "tab_regole": "📚 Regolamento", "tab_squadre": "⚔️ Potenza Squadre",
...
with tab_report:
    ...
    if df_drive is not None:
        ...
        if "df_calcolato" in st.session_state:
            ...
            # Formattazione forzata con puntini direttamente sul DataFrame della classifica per azzerare M e K
