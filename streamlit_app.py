...
# --- FUNZIONI DI CONVERSIONE E PULIZIA RIGOROSA ---
...
def carica_dati_da_drive():
    ...
    if rows and len(rows) > 0:
        ...
        # Conversione rigorosa immediata in interi puri per evitare qualsiasi residuo di M o K
...
def salva_dati_su_drive(sheet, df):
    try:
        ...
        if client_fresco:
            ...
            # Strippaggio totale e salvataggio come numeri interi puri su Google Drive
            for col_f in ["Punti_VS", "Donazioni_Tech", "Premi_Stella"]:
