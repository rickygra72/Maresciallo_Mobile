    ...
    try:
        ...
        if client:
            ...
            if rows and len(rows) > 0:
                ...
                # PULIZIA IMMEDIATA ALLA FONTE: converte Punti_VS e Donazioni_Tech in interi puri eliminando M e K lette da Drive
...
# ==============================================================================
# 3. TAB DATI GOOGLE DRIVE (PROSPETTO UNIFICATO A FORM CON MENU A TENDINA E STELLE DA 0 A 7)
# ==============================================================================
with tab_dati:
    st.subheader("📊 Inserimento Punteggi (Prospetto Unificato con Menu a Tendina)")
    ...
    if df_drive is not None:
        ...
        with st.form("form_inserimento_unificato"):
            ...
            hc6.markdown(f"**{T['col_premi']}**") # Stelle 0-7
            ...
            opzioni_stelle = [0, 1, 2, 3, 4, 5, 6, 7] # Stelle da 0 a 7
...
# ==============================================================================
# 4. TAB CLASSIFICA (PULITA E FORMATTATA CON PUNTINI)
# ==============================================================================
with tab_report:
