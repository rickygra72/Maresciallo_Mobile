...
# --- FUNZIONE DI CATTURA IMMEDIATA ALLEGATI (CALLBACK) ---
def elabora_file_caricati():
    # Accediamo ai file caricati nel widget corrente tramite chiave di sessione
    file_correnti = st.session_state.caricatore_chiave
    if file_correnti:
        for f in file_correnti:
...
# --- FUNZIONI DI ESPORTAZIONE REPORT ---
...
# Usiamo on_change per intercettare i file all'istante dell'upload
st.file_uploader(
