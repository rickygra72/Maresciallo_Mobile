...
# --- FORM DI TRATTAMENTO QUESITO CON MODELLI VALIDATI ---
st.markdown("---")
    ...
    if not chiave_pulita:
        ...
        with st.spinner("Analisi in corso ed elaborazione dati..."):
            try:
                ...
                # --- LISTA DI MODELLI UFFICIALI E STABILI PER EVITARE ERRORI 404 ---
                modelli_disponibili = ['gemini-2.0-flash', 'gemini-1.5-flash', 'gemini-1.5-pro']
                res = None
                errore_ultimo = None
