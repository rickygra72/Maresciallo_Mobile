...
with st.expander("🔒 NOTE SULLA SICUREZZA E PRIVACY DEI DATI"):
    ...
    * **Isolamento della Sessione in Memoria Volatile (RAM):** Tutte le informazioni estratte dai documenti e lo storico della chat risiedono esclusivamente nella memoria RAM volatile assigned alla sessione corrente del dispositivo. 
